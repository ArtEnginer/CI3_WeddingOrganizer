...
class Shop extends CI_Controller
{
    ...
    function category()
    {
        ...
        $products['category'] = $this->productktg->getById($category)->name;
        $params['title'] = 'Kategori ' . $products['category'];
        $products['products'] = $this->product->getByCategory($category);


        get_header($params);
        get_template_part('shop/category', $products);
        get_footer();
    }
}
