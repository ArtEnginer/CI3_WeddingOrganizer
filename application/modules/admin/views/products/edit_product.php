          ...
          <?php if ($product->picture_name != NULL) : ?>
            <div class="tab-content" id="pills-tabContent">
                ...
                <div class="text-center">
                  <div id="productCarousel" class="carousel slide" data-ride="carousel">
                    <ol class="carousel-indicators">
                      ...
                      <?php if ($product->slide_1) : ?>
                        <li data-target="#productCarousel" data-slide-to="1"></li>
                      <?php endif; ?>
                      <?php if ($product->slide_2) : ?>
                        <li data-target="#productCarousel" data-slide-to="2"></li>
                      <?php endif; ?>
                      <?php if ($product->slide_3) : ?>
                    ...
                    <div class="carousel-inner">
                      ...
                      <div class="carousel-item active">
                        <a href="<?php echo base_url('assets/uploads/products/' . $product->picture_name); ?>" class="image-popup">
                          <img src="<?php echo base_url('assets/uploads/products/' . $product->picture_name); ?>" class="d-block w-100" alt="<?php echo $product->name; ?>">
                        </a>
                      </div>
                      ...
                      <?php if ($product->slide_1) : ?>
                        <div class="carousel-item">
                          <a href="<?php echo base_url('assets/uploads/products/' . $product->slide_1); ?>" class="image-popup">
                            <img src="<?php echo base_url('assets/uploads/products/' . $product->slide_1); ?>" class="d-block w-100" alt="<?php echo $product->name; ?> - Slide 1">
                          </a>
                        </div>
                      <?php endif; ?>
                      ...
                      <?php if ($product->slide_2) : ?>
                        <div class="carousel-item">
                          <a href="<?php echo base_url('assets/uploads/products/' . $product->slide_2); ?>" class="image-popup">
                            <img src="<?php echo base_url('assets/uploads/products/' . $product->slide_2); ?>" class="d-block w-100" alt="<?php echo $product->name; ?> - Slide 2">
                          </a>
                        </div>
                      <?php endif; ?>
                      ...
                      <?php if ($product->slide_3) : ?>
                        <div class="carousel-item">
                          <a href="<?php echo base_url('assets/uploads/products/' . $product->slide_3); ?>" class="image-popup">
                            <img src="<?php echo base_url('assets/uploads/products/' . $product->slide_3); ?>" class="d-block w-100" alt="<?php echo $product->name; ?> - Slide 3">
                          </a>
                        </div>
                      <?php endif; ?>
                    </div>
              ...
              <div class="tab-pane fade" id="pills-edit" role="tabpanel" aria-labelledby="pills-profile-tab">
                ...
                <div class="form-group">
                  <label class="form-control-label" for="pic">Slide 1:</label>
                  <input type="file" name="slide_1" class="form-control" id="pic">
                </div>

                <div class="form-group">
                  <label class="form-control-label" for="pic">Slide 2:</label>
                  <input type="file" name="slide_2" class="form-control" id="pic">
                </div>
                <div class="form-group">
                  <label class="form-control-label" for="pic">Slide 3:</label>
                  <input type="file" name="slide_3" class="form-control" id="pic">
                </div>
